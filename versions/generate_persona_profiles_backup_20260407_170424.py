...
personas = {   'Commercial': {   'C-Suite Decision Maker': {   'buying_behavior': {   'authority_level': 'Ultimate - signs off on '
                                                    ...
                                                    'challenges_from_gong': [   'Platform vs. point solution debate - '
                                                                                ...
                                                                                'high stakes',
                                                                                'Andre also raised an issue with the '
                                                                                'smart list not updating, which '
                                                                                'Payphone assured him was being '
                                                                                'addressed',
                                                                                'Payphone offered further Zendesk '
                                                                                'support for an upcoming workshop, as '
                                                                                'Lulalend was having difficulty '
                                                                                'securing time with Trevor and Andrew'],
                                                    ...
                                                    'goals': [   'Platform consolidation - reduce vendor count',
                                                                 ...
                                                                 'The team will leverage historical data to suggest '
                                                                 'use cases and validate them with the client, aiming '
                                                                 'for a 30% automation rate within the first year'],
                                                    ...
                                                    'pain_points': [   'Support org using 5-10 different tools '
                                                                       ...
                                                                       'operations',
                                                                       'Andre also raised an issue with the smart list '
                                                                       'not updating, which Payphone assured him was '
                                                                       'being addressed',
                                                                       'Payphone offered further Zendesk support for '
                                                                       'an upcoming workshop, as Lulalend was having '
                                                                       'difficulty securing time with Trevor and '
                                                                       'Andrew'],
                      ...
                      'CX Champion': {   'buying_behavior': {   'authority_level': 'Medium - needs buy-in from IT, '
                                         ...
                                         'challenges_from_gong': [   'Integration complexity - custom dispatch '
                                                                     ...
                                                                     'not updating, which Payphone assured him was '
                                                                     'being addressed',
                                                                     'Payphone offered further Zendesk support for an '
                                                                     'upcoming workshop, as Lulalend was having '
                                                                     'difficulty securing time with Trevor and Andrew'],
                                         ...
                                         'goals': [   'Scale support operations across regions/brands',
                                                      ...
                                                      'The team will leverage historical data to suggest use cases and '
                                                      'validate them with the client, aiming for a 30% automation rate '
                                         ...
                                         'pain_points': [   'Managing 50-100 agents across multiple teams/shifts',
                                                            ...
                                                            'Andre also raised an issue with the smart list not '
                                                            'updating, which Payphone assured him was being addressed',
                                                            'Payphone offered further Zendesk support for an upcoming '
                                                            'workshop, as Lulalend was having difficulty securing time '
                      ...
                      'Finance/Procurement Gatekeeper': {   'buying_behavior': {   'authority_level': 'High - can '
                                                            ...
                                                            'challenges_from_gong': [   'Procurement appearing 40% '
                                                                                        ...
                                                                                        'requirements',
                                                                                        'Andre also raised an issue '
                                                                                        'with the smart list not '
                                                                                        'updating, which Payphone '
                                                                                        'assured him was being '
                                                                                        'addressed',
                                                                                        'Payphone offered further '
                                                                                        'Zendesk support for an '
                                                                                        'upcoming workshop, as '
                                                                                        'Lulalend was having '
                                                                                        'difficulty securing time with '
                                                                                        'Trevor and Andrew'],
                                                            ...
                                                            'goals': [   'Negotiate favorable contract terms',
                                                                         ...
                                                                         'The team will leverage historical data to '
                                                                         'suggest use cases and validate them with the '
                                                                         'client, aiming for a 30% automation rate '
                                                                         'within the first year'],
                                                            'job_titles': [   'CFO',
                                                                              'VP Finance',
                      ...
                      'IT Influencer': {   'buying_behavior': {   'authority_level': 'High - can veto deals',
                                           ...
                                           'goals': [   'Ensure enterprise-grade security and compliance',
                                                        ...
                                                        'The team will leverage historical data to suggest use cases '
                                                        'and validate them with the client, aiming for a 30% '
                                                        'automation rate within the first year'],
                                           'job_titles': [   'VP IT',
                                                             'Director of IT',
                                           ...
                                           'pain_points': [   'Security audits finding vulnerabilities in old tools',
                                                              ...
                                                              'Andre also raised an issue with the smart list not '
                                                              'updating, which Payphone assured him was being '
                                                              'addressed',
                                                              'Payphone offered further Zendesk support for an '
                                                              'upcoming workshop, as Lulalend was having difficulty '
                                                              'securing time with Trevor and Andrew'],
                      ...
                      'Operations Leader': {   'buying_behavior': {   'authority_level': 'Medium-High - can influence '
                                               ...
                                               'challenges_from_gong': [   'WFM integration requirements - need to '
                                                                           ...
                                                                           'Andre also raised an issue with the smart '
                                                                           'list not updating, which Payphone assured '
                                                                           'him was being addressed',
                                                                           'Payphone offered further Zendesk support '
                                                                           'for an upcoming workshop, as Lulalend was '
                                                                           'having difficulty securing time with '
                                                                           'Trevor and Andrew'],
                                               ...
                                               'goals': [   'Optimize workforce management and capacity planning',
                                                            ...
                                                            'The team will leverage historical data to suggest use '
                                                            'cases and validate them with the client, aiming for a 30% '
                                                            'automation rate within the first year'],
    ...
    'Digital': {   'Customer Service Generalist': {   'buying_behavior': {   'authority_level': 'Low - influencer only',
                                                      ...
                                                      'challenges_from_gong': [   'Need omnichannel - customers reach '
                                                                                  ...
                                                                                  'teammates help',
                                                                                  ', along with Max and Simon, '
                                                                                  'discussed contract finalization '
                                                                                  'issues and a potential auto-renewal '
                                                                                  "problem with Max's account, which "
                                                                                  'Jack resolved'],
                                                      ...
                                                      'objections': [   '"Will the founder approve the cost?"',
                                                                        ...
                                                                        '"La conversación también abordó los costos, '
                                                                        'el cronograma de implementación y la '
                                                                        'superioridad tecnológica de la solución de '
                                                                        'Zendesk"',
                                                                        '"optional items, usage assumptions, and '
                                                                        'potential cost adjustments to meet the '
                                                      ...
                                                      'pain_points': [   'Juggling multiple communication channels',
                                                                         ...
                                                                         'customers',
                                                                         ', along with Max and Simon, discussed '
                                                                         'contract finalization issues and a potential '
                                                                         "auto-renewal problem with Max's account, "
                                                                         'which Jack resolved'],
                   ...
                   'Founder/Owner': {   'buying_behavior': {   'authority_level': 'Complete - no approvals needed',
                                        ...
                                        'challenges_from_gong': [   'Price sensitivity - need startup/small business '
                                                                    ...
                                                                    'Hub, Freshdesk',
                                                                    ', along with Max and Simon, discussed contract '
                                                                    'finalization issues and a potential auto-renewal '
                                                                    "problem with Max's account, which Jack resolved"],
                                        ...
                                        'objections': [   '"This is too expensive for our size"',
                                                          ...
                                                          '"La conversación también abordó los costos, el cronograma '
                                                          'de implementación y la superioridad tecnológica de la '
                                                          'solución de Zendesk"',
                                                          '"optional items, usage assumptions, and potential cost '
                                                          'adjustments to meet the client\'s budget expectations"'],
                                        'pain_points': [   'Wearing too many hats - no time to learn complex tools',
                                                           ...
                                                           ', along with Max and Simon, discussed contract '
                                                           'finalization issues and a potential auto-renewal problem '
                                                           "with Max's account, which Jack resolved"],
    ...
    'Enterprise': {   'CX Executive': {   'buying_behavior': {   'authority_level': 'Executive Sponsor - drives but '
                                          ...
                                          'objections': [   '"We\'ve already invested millions in our current '
                                                            ...
                                                            '", along with Luz from Avis Budget Car Rental, LLC"',
                                                            '"The team also planned for future development, including '
                                                            'payment information and addressing outstanding questions '
                                                            'about hold ownership"'],
                      ...
                      'Enterprise IT Architect': {   'buying_behavior': {   'authority_level': 'Can block - must '
                                                     ...
                                                     'objections': [   '"Does this meet our enterprise security '
                                                                       ...
                                                                       'maintenance?"',
                                                                       '", along with Luz from Avis Budget Car Rental, '
                                                                       'LLC"',
                                                                       '"The team also planned for future development, '
                                                                       'including payment information and addressing '
                                                                       'outstanding questions about hold ownership"'],
                      ...
                      'Global Operations Leader': {   'buying_behavior': {   'authority_level': 'High influence - '
                                                      ...
                                                      'objections': [   '"Our operations are too complex for standard '
                                                                        ...
                                                                        '", along with Luz from Avis Budget Car '
                                                                        'Rental, LLC"',
                                                                        '"The team also planned for future '
                                                                        'development, including payment information '
                                                                        'and addressing outstanding questions about '
                                                                        'hold ownership"'],
